...
<div class="modal fade" id="EditStudent<?php echo $row['StudentID']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel<?php echo $row['StudentID']; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel<?php echo $row['StudentID']; ?>">Edit Record</h5>
      ...
      <div class="modal-body">
        ...
        <form action="../APP/CRUDProcess.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="MiddleName" value="<?php echo $row['MName']; ?>">
          </div>
           <div class="form-group">
